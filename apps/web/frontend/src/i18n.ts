...
export const i18n = {
  en: {
    ...
    runDir: "Run",
    runs: "Runs",
    runsSubtitle: "Searchable local run records from SQLite.",
    refresh: "Refresh",
    ...
    source: "Source",
    tools: "Tools",
    toolsSubtitle: "Registered Harness tools with schema, permission, and timeout metadata.",
    ...
    yes: "Yes",
    no: "No",
    memorySubtitle: "Local episodic and semantic memory exposed by Phase 6 APIs.",
    search: "Search",
    noEpisodes: "No episode memory.",
    noSemanticMemory: "No semantic memory.",
    tasks: "Tasks",
    tasksSubtitle: "Task Router catalog, request schemas, and manual dispatch.",
    ...
    hqsSubtitle: "Current system HQS and persisted run-level HQS reports.",
    ...
    traceViewerSubtitle: "Browse local trace files, inspect steps, and run trace diagnosis.",
    ...
    dashboardSubtitle: "Local Agent runtime, run observability, task routing, memory, trace, and quality signals in one place.",
    newChat: "New Chat",
    ...
    settings: "Settings",
    settingsSubtitle: "Runtime mode, provider configuration, local directories, and API links.",
    ...
    readonly: "readonly",
    apiKey: "API Key",
    skillsSubtitle: "Versioned Skill memory with markdown, metadata, and diffs.",
    metadata: "Metadata",
  ...
  zh: {
    ...
    runDir: "运行目录",
    runs: "运行记录",
    runsSubtitle: "来自 SQLite 的本地可查询运行索引。",
    refresh: "刷新",
    noRuns: "暂无运行记录。",
    taskType: "任务类型",
    created: "创建时间",
    ...
    source: "来源",
    tools: "工具",
    toolsSubtitle: "Harness 工具目录，包含 schema、permission 和 timeout 元数据。",
    noTools: "没有已注册工具。",
    permission: "权限",
    timeout: "超时",
    idempotent: "幂等",
    ...
    yes: "是",
    no: "否",
    memorySubtitle: "Phase 6 API 暴露的本地 episodic 和 semantic memory。",
    search: "搜索",
    noEpisodes: "暂无 episode memory。",
    noSemanticMemory: "暂无 semantic memory。",
    tasks: "任务",
    tasksSubtitle: "Task Router 目录、请求 schema 和手动调度入口。",
    ...
    hqsSubtitle: "当前系统 HQS 和已持久化的 run 级 HQS 报告。",
    ...
    noDimensions: "暂无维度。",
    traceViewer: "Trace Viewer",
    traceViewerSubtitle: "浏览本地 trace 文件、检查步骤并运行 trace diagnosis。",
    noTraces: "暂无 trace。",
    traceId: "Trace ID",
    rawTrace: "原始 Trace",
    ...
    dashboardSubtitle: "集中查看本地 Agent 运行时、运行观测、任务路由、记忆、Trace 和质量信号。",
    newChat: "新对话",
    currentRun: "当前运行",
    openRuns: "打开 Runs",
    open: "打开",
    ...
    phase7CompleteSurface: "Phase 7",
    settings: "设置",
    settingsSubtitle: "运行模式、Provider 配置、本地目录和 API 链接。",
    projectRoot: "项目根目录",
    ...
    readonly: "只读",
    apiKey: "API Key",
    skillsSubtitle: "版本化 Skill 记忆，支持查看 Markdown、metadata 和 diff。",
    metadata: "元数据",
